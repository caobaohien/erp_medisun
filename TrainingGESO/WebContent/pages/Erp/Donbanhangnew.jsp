...
<%
	IThongtindonbanhang obj = (IThongtindonbanhang) session.getAttribute("obj");
	String userId = (String) session.getAttribute("userId");
	String userTen = (String) session.getAttribute("userTen");
	Utility util = (Utility) session.getAttribute("util");
	List<Isanpham> listsp =obj.getListSp();
	ResultSet dataListkh=obj.getRskh();
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post" action="../../DonbanhangNewSvl">
					...
					<TR class="tbdarkrow">
						...
						<td <%
							...
							align="left"><A href="javascript:print_excel()"> <IMG
								...
								style="border-style: outset; width: 30px; height: 30px">
						</A> <% } %></td>
						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel"><input type="text" name="tongtien"
									id="tongtien" value="<%=obj.getTongtien()%>"
							...
							<TR>
								...
								<TD class="plainlabel"><input type="text" class="days"
									name="ngaychungtu" value="<%=obj.getNgaychungtu()%>"></TD>
							...
							<tr>
								...
								<TD class="plainlabel"><select name="khachhang"
									style="width: 200px">
										...
										<%
											if (dataListkh != null) {
												while (dataListkh.next()) {
													if (dataListkh.getString("pk_seq").equals(obj.getKhachhang())) {
										%>
										<option value="<%=dataListkh.getString("pk_seq")%>"
											selected="selected"><%=dataListkh.getString("TEN")%>
										</option>
										<%
											} else {
										%>
										<option value="<%=dataListkh.getString("pk_seq")%>"><%=dataListkh.getString("TEN")%>
										</option>
										<%
											}
												}
									...
									<DIV id="ndGhiChu"
										...
										<table width="100%" align="center">
											...
											<tr>
												...
												<td width="80%"><input style="width: 100%" name="mancc"
													type="text" value="<%=obj.getKhachhang()%>"></td>
											</tr>

											<tr>
												<td width="300px">Tên khách hàng</td>
												<td width="300px"><input style="width: 100%"
													name="tenncc" type="text"
													value="<%=obj.getTenkhachhang()%>"></td>
											</tr>

											<tr>
												<td width="300px">Điện thoại</td>
												<td width="300px"><input style="width: 100%"
													type="text" name="dienthoaincc" value
													<%= obj.getDienthoai() %>></td>
											</tr>
											...
											<tr>
												...
												<td width="300px"><input style="width: 100%"
													type="text" name="diachincc" value <%= obj.getDiachi() %>>
												</td>
											</tr>
						...
						<div align="left" style="width: 100%; float: none; clear: none;">
							...
							for(  i=0;i<listsp.size();i++) {
								...
								<TR>
									...
									<Td align="center" width="5%"><input type="text"
										name="soluong" value="<%=sp.getSoluong()%>"></Td>
									<Td align="center" width="10%"><input type="text"
										name="dongia" value="<%=sp.getDongia()%>"></Td>
									<Td align="center" width="10%"><input type="text"
										name="chietkhau" value="<%=sp.getChietkhau()%>"></Td>
									<Td align="center" width="10%"><input type="text"
										name="thanhtien"
										value="<%=formatter.format(sp.getThanhtien())%>"></Td>
								</TR>
							 ...
							 for(  i=listsp.size();i<listsp.size()+20 ;i++) {
								...
								<TR>
									...
									<Td align="center" width="10%"><input type="text"
										name="dongia" value=""></Td>
									<Td align="center" width="10%"><input type="text"
										name="chietkhau" value=""></Td>
									<Td align="center" width="10%"><input type="text"
										name="thanhtien" value=""></Td>
