...
%>
<%
	IDonbanhang obj = (IDonbanhang) session.getAttribute("obj");
%>
...
%>
<%
	ResultSet dataListkh = (ResultSet) obj.getRskh();
%>
...
<body>
	<form name="erpDmhForm" method="post" action="../../DonbanhangListSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Danh sách don hang</div>
			...
			<div id="cotent" style="width: 100%; float: none">
				...
				<div align="left"
					...
					<fieldset>
						<legend>
							<span class="legendtitle"> So don hang </span>&nbsp;&nbsp;
										...
										<%
											if (dataListkh != null) {
												while (dataListkh.next()) {
													if (dataListkh.getString("pk_seq").equals(
															obj.getKhachhang())) {
										%>
						...
						<TABLE width="100%" border="1" cellspacing="1" cellpadding="4">
							...
							<TR class='tblightrow'>
								...
								<TD align="center"><%=dataList.getString("KHACHHANG")%></TD>
								<%
								...
								<TD align="center"><A
									href="../../DonbanhangNewSvl?userId=<%=userId%>&display=<%=dataList.getString("ma")%>">
										<IMG src="../images/Display20.png" alt="Hiển thị"
										title="Hiển thị" border=0>
								</A>&nbsp; <%
 	if (tt.equals("0")) {
 %> <A
									href="../../DonbanhangListSvl?userId=<%=userId%>&delete=<%=dataList.getString("ma")%>">
										<img src="../images/DeleteRed_32.png" width="20" height="20"
										border=0 name=delete alt="Xóa" title="Xóa">
								</A>&nbsp; <A
									href="../../DonbanhangNewSvl?userId=<%=userId%>&update=<%=dataList.getString("ma")%>">
										<img src="../images/edit32.png" width="20" height="20"
										alt="Cap nhat" title="Cập nhật" border=0>
								</A>&nbsp; <A
									href="../../DonbanhangListSvl?userId=<%=userId%>&chot=<%=dataList.getString("ma")%>">
