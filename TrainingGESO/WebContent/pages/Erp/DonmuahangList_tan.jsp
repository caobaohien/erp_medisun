		...
		<div id="main" style="width: 100%; padding-left: 2px">
			...
			<div id="cotent" style="width: 100%; float: none">
				...
				<div align="left"
					...
					<fieldset>
						<legend>
							<span class="legendtitle"> ĐƠN MUA HÀNG </span>&nbsp;&nbsp;
						...
						<TABLE width="100%" cellpadding="6" cellspacing="0">
							<tr>
								...
								<TD class="plainlabel"><input type="text" name="txtMaMH"
									style="width: 200px" onchange="submitform()"
									value="<%=obj.getMamuahang()%>"></TD>
							</tr>
							<tr>
								...
								<td class="plainlabel"><select name="cbNhacungcap"
									onchange="submitform()" style="width: 200px">
										...
										<option selected="selected"
											value="<%=listKH.getString("NHACUNGCAP")%>">
											<%=listKH.getString("TEN") %>
										</option>
										<%
												}else{
												%>
										<option value="<%=listKH.getString("NHACUNGCAP")%>">
											<%=listKH.getString("TEN")%>
										</option>
										<%
				                        	   }
					...
					int m = 0;
                   		...
                   		if(dataList != null)
                   		{
							...
							<TR class='tblightrow'>
								...
								<TD align="center"><A
									href="../../DonmuahangNewSvl_tan?userId=<%=userId%>&display=<%= dataList.getString("MaMH") %>">
										<IMG src="../images/Display20.png" alt="Hiển thị"
										title="Hiển thị" border=0>
								</A>&nbsp; <% if(tt.equals("0") || tt.equals("1")){ %> <A
									href="../../DonmuahangNewSvl_tan?userId=<%=userId%>&update=<%= dataList.getString("MaMH")%>">
										<IMG src="../images/edit32.png" width="20" height="20"
										alt="Cap nhat" title="Cập nhật" border=0>
								</A>&nbsp; <A id='chotphieu<%=dataList.getString("MaMH")%>' href="">
									...
									href="../../DonmuahangListSvl_tan?userId=<%=userId%>&delete=<%= dataList.getString("MaMH") %>">
