		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Hồ sơ>Tạo hợp đồng</div>
			...
			<div id="cotent" style="width: 100%; float: none; height: auto">
				<div align="left"
					...
					<fieldset>
						<legend>
							<span class="legendtitle"> Tiêu chí tìm kiếm </span>&nbsp;&nbsp;
						</legend>
						<TABLE width="100%" cellpadding="6" cellspacing="0">
							<tr>
								<TD class="plainlabel">Mã hợp đồng</TD>
								<TD class="plainlabel"><input type="text" name="txtMaHD"
									style="width: 200px" onchange="submitform()"
									value="<%=obj.getPk_hopdong()%>"></TD>
							</tr>
							<tr>
								<TD class="plainlabel">Hồ sơ</TD>
								<td class="plainlabel"><select name="cbHoso"
							...
							%>
										<option selected="selected"
											value="<%=rsListHoso.getString("MAHOSO")%>">
											<%=rsListHoso.getString("TEN") %>
										</option>
										<%
								}else{
							%>
										<option value="<%=rsListHoso.getString("MAHOSO")%>">
											<%=rsListHoso.getString("TEN")%>
										</option>
										<%
				            	}
				...
				<div align="left"
					...
					<fieldset>
						<legend>
							<span class="legendtitle"> Hồ sơ - Hợp
								đồng&nbsp;&nbsp;&nbsp;</span> <a class="button"
								href="javascript:taomoi();"> <img style="top: -4px;"
								src="../images/New30.png" alt=""> <b>Tạo hợp
									đồng&nbsp; </b></a>
						</legend>
		           ...
		           %>
		                    ...
		                    %> <%= Trangthai %>
								...
								<TD align="center"><A
									href="../../TaohopdongSvl_tan?userId=<%=userId%>&display=<%= dataList.getString("MAHD")%>">
										<IMG src="../images/Display20.png" alt="Hiển thị"
										title="Hiển thị" border=0>
								</A>&nbsp; <A
									href="../../TaohopdongSvl_tan?userId=<%=userId%>&update=<%= dataList.getString("MAHD")%>">
										<IMG src="../images/Edit20.png" width="20" height="20"
										alt="Cap nhat" title="Cập nhật" border=0>
								</A>&nbsp; <A id='chotphieu<%=dataList.getString("MAHD")%>' href="">
