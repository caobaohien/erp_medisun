...
<%
	IDonHang obj =(IDonHang)session.getAttribute("donhangsua");
	//ISanPham sp =(ISanPham)session.getAttribute("donhangfix");
										...
										<tbody id="san_pham">
											...
											<th align="center"width="10%">Thành tiền</th>
													...
													for(j=0;j<listSp.size();j++){
														...
														<input type="text"name="masp"id="masp"value="<%=listSp.get(j).getMaSP() %>"onkeyup="ajax_showOptions(this,'donhangsua',event)"
