...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dhnew" method="post" action="../../DonbanhangSvl_cuong">
		<input type="hidden" name="userId" value='<%=userId%>'> <input
			...
			name="id" value='<%=dhnew.getId()%>'>
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation">Thông tin đơn bán hàng</div>
				...
				<TABLE border="0" cellpadding="0" cellspacing="0">
					<TR class="tbdarkrow">
						...
						<TD width="30px" align="left"><span id="btnUndo"> <A
								href="../../DonbanhangListSvl_cuong?userId=<%=userId%>"> <IMG
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					...
					<textarea name="dataerror" id="Msg" rows="1" readonly="readonly"
						style="width: 100%"><%=dhnew.getmsg()%></textarea>
				</fieldset>
			</div>
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel"><input type="date"
									name="ngaychungtu" value="<%=dhnew.getNgay()%>"></TD>
							</TR>
							<TR>
								<TD class="plainlabel">Số tiền</TD>
								<TD class="plainlabel"><input type="text" name="tongtien"
									value="<%=dhnew.getTongTien()%>"></TD>
							</TR>
