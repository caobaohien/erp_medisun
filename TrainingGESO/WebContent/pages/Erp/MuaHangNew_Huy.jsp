		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation">Don mua hang moi</div>
				...
				<TABLE border="0" cellpadding="0" cellspacing="0">
					<TR class="tbdarkrow">
						...
						<TD width="30px" align="left"><span id="btnUndo"> <A
								href="../../MuaHangSvl?userId=<%=userId%>"> <IMG
									src="../images/Back_undo.png" title="Undo" alt="Undo"
									border="1px" style="border-style: outset"></A>
						</span></TD>
						<td width="30px" align="left"><A href="javascript:print()">
								<IMG src="../images/Excel.jpg" title="In báo cáo"
								alt="In báo cáo" border="1px"
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<tr>
								...
								<td class="plainlabel"><select name="tenncc"
									style="width: 200px">
										<option value=""></option>
										<%
				                    	 		if(dataListncc!=null)
										...
										<option selected="selected"
											value="<%= dataListncc.getString("PK_SEQ") %>"><%= dataListncc.getString("TEN") %></option>
										<%} else%>
										<%{ %>
										...
										<table width="100%" align="center">
											<tr>
												<th colspan="2" width="500px"
													style="font-size: 14px; font-weight: bold;">THÊM NHA
													CUNG CAP</th>
											...
											<tr>
												...
												<td width="80%"><input style="width: 100%"
													name="manhacc" type="text" value=""></td>
											</tr>

											<tr>
												<td width="300px">Tên</td>
												<td width="300px"><input style="width: 100%"
													name="tennhacc" type="text" value=""></td>
											</tr>

											<tr>
												<td width="300px">Dia chi</td>
												<td width="300px"><input style="width: 100%"
													type="text" name="diachi" value=""></td>
											</tr>

											<tr>
												<td width="300px">Dien thoai</td>
												<td width="300px"><input style="width: 100%"
													type="text" name="dienthoai" value=""></td>
											</tr>
							...
							<TR>
								...
								<TD class="plainlabel"><input class="days" type="text"
									name="ngaymuahang" id="ngaymuahang" value="<%=obj.getngay() %>"
									maxlength="10"></TD>
						...
						<div align="left" style="width: 100%; float: none; clear: none;">
							...
							int i;
								...
								<TR>
									...
									<Td align="center" width="10%"><input type="text"
										name="thanhtien" value="<%=sp.getThanhtien()%>"></Td>
								...
								%>
									<td><a href="" id="muahangchitiet<%=i %>"
										rel="ndGhiChu<%=i%>"> &nbsp; <img alt="Thêm khách hàng"
											src="../images/vitriluu.png">Thêm nha cung cap
									</a>
										<DIV id="ndGhiChu<%=i%>"
											style="position: absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 500px; min-height: 150px; overflow: auto; padding: 4px;">
											<table width="100%" align="center">
