...
<SCRIPT language="javascript" type="text/javascript">
	 ...
	 {   
		...
		document.forms["erpDmhForm"].action.value = "savenew";
	    document.forms["erpDmhForm"].submit();
	 }
	 function print_pdf()
	 {   
...
<body>
	<form name="erpDmhForm" method="post" action="../../KhachhangSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Danh sách khách hàng</div>
			...
			<div id="cotent" style="width: 100%; float: none">
				...
				<div align="left"
					...
					<fieldset>
						<legend>
							<span class="legendtitle"> Khách hàng </span>&nbsp;&nbsp;
						...
						<TABLE width="100%" border="1" cellspacing="1" cellpadding="4">
							<TR class="tbheader">
								...
								<TH align="center" width="17%">Điện thoại</TH>
							...
							<tr>
								...
								<td align="center" colspan="4"><input type="text" name="ma"
									style="width: 100%" onchange="submitform()"
									value="<%=obj.getMa()%>"></td>


								<td align="center">
									<%
                            String mang[] =new String[]{"0","1"};
                    		String mangten[] =new String[]{"Ngưng hoạt động","Hoạt động"};
                    	...
                    	%>
								...
								<td align="center"><A href="javascript:submitform()"> <IMG
							...
							<tr class='tblightrow'>
								...
								<td align="center"><input type="text" name="manew"
									style="width: 100%" value="<%=obj.getMaNew()%>"> <input
									type="hidden" name="idnew" style="width: 100%"
									value="<%=obj.getId()%>"></td>
								<td align="center"><input type="text" name="tennew"
									style="width: 100%" value="<%=obj.getTenNew()%>"></td>
								<td align="center"><input type="text" name="dienthoainew"
									style="width: 100%" value="<%=obj.getDienthoaiNew()%>"></td>
								<td align="center"><input type="text" name="diachinew"
									style="width: 100%" value="<%=obj.getDiachiNew()%>"></td>

								<td align="center">
									<% if(obj.getTrangthaiNew().equals("1")){ %> <input
									checked="checked" type="checkbox" name="checktrangthai"
									value='1'> <%}else{ %> <input type="checkbox"
									name="checktrangthai" value='1'> <%} %>

								</td>
								<td align="center"><A href="javascript:save_new()"> <IMG
										src="../images/1455966997_save.png" title="Thêm mới"
										alt="Luu lai" border="1px"
										style="border-style: outset; width: 25px; height: 25px"></A>
								</td>
					...
					int m = 0;
                   		...
                   		if(dataList != null)
                   		{
							...
							<TR class='tblightrow'>
								...
								<TD align="center"><%= dataList.getString("diachi") %></TD>
								...
								<TD align="center"><A
									href="../../KhachhangSvl?userId=<%=userId%>&update=<%= dataList.getString("sochungtu")%>">
