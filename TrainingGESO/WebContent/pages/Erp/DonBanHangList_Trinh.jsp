<%@page import="geso.erp.beans.donbanhang_trinh.IDonBanHangList_trinh"%>
<%@page import="geso.erp.beans.donbanhang_trinh.*"%>
					...
					<fieldset>
						...
						<TABLE width="100%" border="0" cellspacing="1" cellpadding="4"
							...
							<TR class="tbheader">
								...
								<TH align="center" width="13%">Khách Hàng</TH>
                   	...
                   	%>
		                    ...
		                    %>
								...
								<TD align="center"><%= dataList.getString("MADONHANG") %></TD>
								...
								<TD align="left"><A
									href="../../DonBanHangNew_TrinhSvl?userId=<%=userId%>&display=<%= dataList.getString("MADONHANG") %>">
										<IMG src="../images/Display20.png" alt="Hiển thị"
										title="Hiển thị" border=0>
								</A>&nbsp; <% 
				                    	if (!maTrangThai.equals("2")) {
				                    %> <% if (!maTrangThai.equals("1")) {%> <A
									href="../../DonBanHang_TrinhSvl?userId=<%=userId%>&chot=<%= dataList.getString("MADONHANG")%>">
										<IMG src="../images/Chot.png" width="20" height="20"
										alt="Chot don hang" title="Chốt" border=0>
								</A>&nbsp; <A
									href="../../DonBanHangNew_TrinhSvl?userId=<%=userId%>&update=<%= dataList.getString("MADONHANG") %>">
										<IMG src="../images/edit32.png" width="20" height="20"
										alt="Cap nhat" title="Cập nhật" border=0>
								</A>&nbsp; <A
									href="../../DonBanHang_TrinhSvl?userId=<%=userId%>&delete=<%= dataList.getString("MADONHANG")%>">
