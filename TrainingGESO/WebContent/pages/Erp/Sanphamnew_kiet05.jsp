<%@page import="geso.erp.beans.sanpham_kiet05.ISanpham"%>
...
<% 
	...
	ResultSet rsdvt=nccBean.getRsdDvt();
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post" action="../../SanphamnewSvl_kiet05">
							...
							<TR>
								...
								<TD class="plainlabel"><select name="donvi"
									style="width: 500px">
										...
										<%if(rsdvt!=null) {
										while(rsdvt.next()) {
											if(rsdvt.getString("pk_seq").equals(nccBean.getDonvitinh())){
												%>
