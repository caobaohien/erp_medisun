	...
	try
	{
		...
		String view = query;
	   	...
	   	System.out.println(query);
	   	  	...
	   	  	command=" SELECT SP.PK_SEQ,SP.MA,SP.TEN,ISNULL(DV.TEN,'') AS DONVI,SP.SOLUONG AS SOLUONGTON,ISNULL(GIABAN,0) AS GIABAN "+
				...
				{ 
						while(sp.next())
						{
							...
							out.print("###" + sp.getString("ma") + " -- " + tensp + " [" + sp.getString("donvi") + "] [" + formatter.format(sp.getDouble("soluongton")) + "] [" + formatter.format(sp.getDouble("giaban")) + "] [" + sp.getString("pk_seq") + "]|"); //luu y: bat buoc phai co dau phan cach '|' o cuoi moi dong'
						}	
						sp.close();
