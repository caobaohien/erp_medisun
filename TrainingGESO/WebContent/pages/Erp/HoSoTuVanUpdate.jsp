			...
			<fieldset style="margin-top: 5px">
				<TABLE width="100%" cellpadding="6px" cellspacing="0px">
					<tr>
						...
						<td class="plainlabel"><label class="plainlabel">Ngày
								Tư vấn:</label> <input class="days" type="text" maxlength="10"
						...
						<tr>
							<td colspan="4" style="background-color: #C5E8CD"><a href=""
								id="noidungGhiChu" rel="ndGhiChu">&nbsp; <img
									alt="Thêm Quốc Gia" src="../images/vitriluu.png">Chi
									Tiết Học Sinh
							</a>
								<DIV id="ndGhiChu"
				...
				<fieldset style="margin-top: 5px">
					...
					<TABLE width="100%" cellpadding="6px" cellspacing="0px"
                      ...
                      {%> <a href="" id="themqg" rel="themquocgia">
									&nbsp; <img alt="Thêm Quốc Gia" src="../images/vitriluu.png">Thêm
									Quốc Gia
							</a>
								<DIV id="themquocgia"
									...
									<table width="100%" align="center">
										<tr>
											<th colspan="2" width="500px"
												style="font-size: 14px; font-weight: bold;">THÊM QUỐC
												GIA</th>

										</tr>

										<tr>
											<td width="20%">Mã quốc gia</td>
                        ...
                        {%> <input type="radio" checked="checked"
								...
								value="1" />Không <%}else if(obj.getTiemnang().equals("1")){ %> <input
