		...
		<div id="main" style="width: 100%; padding-left: 2px">
			...
			<div id="cotent" style="width: 100%; float: none">
					...
					<fieldset>
						...
						<TABLE width="100%" cellpadding="6" cellspacing="0">
							...
							<tr>
								...
								<TD class="plainlabel"><input type="text" name="dienthoai"
									style="width: 200px" onchange="submitform()"
				...
				<div align="left"
					...
					<fieldset>
						<legend>
							<span class="legendtitle">THÊM MỚI HỒ SƠ </span>&nbsp;&nbsp; <span
								id="btnthem"> <A href="javascript:taomoi()"> <IMG
						...
						<TABLE width="100%" border="1" cellspacing="1" cellpadding="4">
                   		...
                   		if(dataList != null)
                   		{
							...
							<TR class='tblightrow'>
								...
								<TD align="center">
									<% if(!tthai.equals("4")){%> <A
									href="../../HoSoUpdateSvl?userId=<%=userId%>&display=<%= dataList.getString("PK_SEQ") %>"><IMG
										src="../images/Display20.png" alt="Hiển thị" title="Hiển thị"
										border=0></A>&nbsp; <% if(tthai.equals("0")){%> <A
									href="../../HoSoUpdateSvl?userId=<%=userId%>&update=<%= dataList.getString("PK_SEQ")%>">
										<IMG src="../images/edit32.png" width="20" height="20"
										alt="Cap nhat" title="Cập nhật" border=0>
								</A>&nbsp; <A
									href="../../HoSoListSvl?userId=<%=userId%>&delete=<%= dataList.getString("PK_SEQ") %>"><img
										src="../images/DeleteRed_32.png" width="20" height="20"
										border=0 alt="Xóa hoc sinh" title="Xóa hồ sơ"
										onclick="if(!confirm('Bạn có muon xoa hồ sơ này?')) return false;"></A>&nbsp;

									<A
									href="../../HoSoUpdateSvl?userId=<%=userId%>&tuvan=<%= dataList.getString("PK_SEQ") %>"><IMG
										src="../images/Next20.png" alt="Tư vấn" title="Tư Vấn"
										border=0></A> <%} %> <%} %>
								</TD>
							</TR>
							<%} %>
