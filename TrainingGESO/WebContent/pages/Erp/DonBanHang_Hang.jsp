<%@page import="geso.erp.beans.donbanhang_hang.IDonBanHangList_Hang"%>
<%@page import="geso.erp.beans.donbanhang_hang.*"%>
...
<%
	...
	IDonBanHangList_Hang obj = (IDonBanHangList_Hang) session.getAttribute("obj"); //doi tuong truyen vao phai giong voi doi tuong ben
...
<body>
	<form name="erpDmhForm" method="post" action="../../DonBanHang_HangSvl">
					...
					<fieldset>
                   	...
                   	%>
		                    ...
		                    %>
								...
								<TD align="center"><A
									href="../../DonBanHangUpdate_HangSvl?userId=<%=userId%>&display=<%= dataList.getString("MADONHANG") %>">
										<IMG src="../images/Display20.png" alt="Hiển thị"
										title="Hiển thị" border=0>
								</A>&nbsp; <% 
				                    	if (!maTrangThai.equals("2")) {
				                    %> <% if (!maTrangThai.equals("1")) {%> <A
									href="../../DonBanHang_HangSvl?userId=<%=userId%>&chot=<%= dataList.getString("MADONHANG")%>">
										<IMG src="../images/Chot.png" width="20" height="20"
										alt="Chot don hang" title="Chốt" border=0>
								</A>&nbsp; <A
									href="../../DonBanHangUpdate_HangSvl?userId=<%=userId%>&update=<%= dataList.getString("MADONHANG") %>">
										<IMG src="../images/edit32.png" width="20" height="20"
										alt="Cap nhat" title="Cập nhật" border=0>
								</A>&nbsp; <A
									href="../../DonBanHang_HangSvl?userId=<%=userId%>&delete=<%= dataList.getString("MADONHANG")%>">
