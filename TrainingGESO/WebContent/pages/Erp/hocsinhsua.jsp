...
<%
// lay gia tri session
	IHocSinh obj = (IHocSinh)session.getAttribute("hocsinhsua");
	String userId = (String)session.getAttribute("userId");
	String userTen = (String)session.getAttribute("userTen");
// lay danh sach lop
	ResultSet RsLop = obj.getRsLop();
	//ResultSet Rstenhocsinh = obj.getRstenhocsinh();
...
<head>
   ...
   <link type="text/css" rel="stylesheet" href="../css/mybutton.css">
	...
	<Script type="text/javascript">
	function submitform(){
		document.forms["hocsinhlist"].action.value = "tim";
		document.forms["hocsinhlist"].submit();
	}
	function saveform(){
		document.forms["hocsinhlist"].action.value = "luusua";
		document.forms["hocsinhlist"].submit();
	}
	</Script>
</head>
...
<div id="cotent" style="width:100%; float:none">
	...
	<TABLE width="100%" cellpadding="6" cellspacing="0">
		<tr>
			...
			<TD class="plainlabel">
			<select name="lop" id="lop" style="width:206px">                         <!-- onchange="submitform()" -->
				<option value="<%=obj.getMaLop()%>">Chọn Lớp</option>
			<%
			  if(RsLop!=null){
				  while(RsLop.next()){
	   ...
	   <tr style="font-size:10px">
	   		...
	   		<td class="plainlabel">
	   		<input type="text" name="tenhocsinh" id="tenhocsinh" style="width:206px"value="<%=obj.getTenHS()%>">
	   		</td>
	   </tr>
	   ...
	   <tr style="font-size:10px">
	   		...
	   		<td class="plainlabel">
	   		<input type="text"name="mahocsinh"id="mahocsinh"style="width:206px"value="<%=obj.getMaHS()%>">
	   		</td>
	   </tr>
</TABLE>
</fieldset>
