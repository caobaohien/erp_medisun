						...
						<TABLE class="tabledetail" width="100%" border="0" cellpadding="2"
							...
							<TR>
								...
								<td><input type="text" name="tenSanPham"
									value="<%=sp.getTenSanPham()%>"></td>
								<td><input type="text" name="donViTinh"
									value="<%=sp.getDonViTinh()%>"></td>
							...
							<TR>
								<td><input type="text" value="<%= i + 1 %>"
									style="text-align: center;" readonly="readonly"> <input
									type="hidden" name="idsp" value=""></td>
								<td><input type="text" name="maSanPham" value=""
									onkeyup="ajax_showOptions(this,'donmuahang',event)"
									AUTOCOMPLETE="off"></td>
								...
								<td><input type="text" name="donGia" value=" "
									readonly="readonly"></td>
								<td><input type="text" name="thanhTien" value=" "
									readonly="readonly"></td>
							</TR>
							<%
							i++;
