...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post"
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					<legend class="legendtitle"> Thêm danh sách định hướng
						hoạt động </legend>
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">

							<tr>
								<TD class="plainlabel">Tình trạng thị trường</TD>
								<TD class="plainlabel"><input type="text" name="tinhtrang"
									style="width: 400px" value="<%=obj.getTinhtrangthitruong()%>"
							...
							<tr>
								...
								<td class="plainlabel">
									...
									%> <select readonly="readonly" name="thang"
									style="width: 200px">
										<option value=""></option>
										<%
							...
							<tr>
								...
								<td class="plainlabel">
									...
									%> <select name="nam" readonly="readonly" style="width: 200px">
										<option value=""></option>
										<%
							...
							<tr>
								...
								<td class="plainlabel">
									...
									%> <select name="thangdinhhuong" readonly="readonly"
									style="width: 200px">
										<option value=""></option>
										<%
							...
							<tr>
								...
								<td class="plainlabel">
									...
									%> <select name="quydinhhuong" readonly="readonly"
									style="width: 200px">
										<option value=""></option>
										<%
						...
						<div align="left" style="width: 100%; float: none; clear: none;">
							<TABLE class="tabledetail" width="100%" border="0"
								...
								<TR class="tbheader">
									...
									<TH align="center" width="10%">Tên hoạt động</TH>
									<TH align="center" width="35%">Mô tả</TH>
									<TH align="center" width="10%">Kinh phí</TH>
									<TH align="center" width="10%">Từ ngày</TH>
									<TH align="center" width="10%">Đến ngày</TH>
									<TH align="center" width="10%">Số lượng KH tiềm năng</TH>
									<TH align="center" width="10%">Số lượng hành động</TH>
								</TR>
							...
							for(  i=0;i<listhd.size();i++) {
								...
								<TR>
									...
									<Td align="center" width="35%"><input type="text"
										name="mota" value="<%=hd.getMota()%>" readonly="readonly">
									</Td>
									<Td align="center" width="10%"><input type="text"
										name="kinhphi" value="<%=hd.getKinhphi()%>"
										readonly="readonly"></Td>
									...
									<Td align="center" width="10%"><input class="days"
										...
										readonly="readonly"></Td>
									<Td align="center" width="10%"><input type="text"
										name="slkh" value="<%=hd.getSoluongkh()%>" readonly="readonly">
									</Td>
									<Td align="center" width="10%"><input type="text"
										name="slhd" value="<%=hd.getSoluonghd()%>" readonly="readonly">
									</Td>
								</TR>
							 ...
							 for(i=listhd.size();i<listhd.size()+10 ;i++) {
								...
								<TR>
									...
									<Td align="center" width="10%"><input type="text"
										name="tenhd" value="" readonly="readonly"></Td>
									<Td align="center" width="35%"><input type="text"
										name="mota" value="" readonly="readonly"></Td>

									<Td align="center" width="5%"><input type="text"
										name="kinhphi" value="" readonly="readonly"></Td>
									<Td align="center" width="5%"><input class="days"
										type="text" name="tungay" value="" readonly="readonly"></Td>
									<Td align="center" width="5%"><input class="days"
										type="text" name="denngay" value="" readonly="readonly"></Td>
									<Td align="center" width="5%"><input type="text"
										name="slkh" value="" readonly="readonly"></Td>
									<Td align="center" width="5%"><input type="text"
										name="slhd" value="" readonly="readonly"></Td>
