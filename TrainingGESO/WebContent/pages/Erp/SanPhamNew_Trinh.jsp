...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post" action="../../SanPhamNew_TrinhSvl">
		<input type="hidden" name="userId" value='<%=userId%>'> <input
			...
			name="id" value='<%=objnew.getMaSanPham()%>'>
				...
				<TABLE border="0" cellpadding="0" cellspacing="0">
					<TR class="tbdarkrow">
						...
						<TD width="30px" align="left"><span id="btnUndo"> <A
								href="../../SanPham_TrinhSvl?userId=<%=userId%>"> <IMG
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					...
					<textarea name="dataerror" id="Msg" rows="1" readonly="readonly"
						style="width: 100%"><%=objnew.getMessage()%></textarea>
				</fieldset>
			</div>
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
								...
								<TD class="plainlabel"><select name="donVi"
									style="width: 500px">
										...
										<option value="<%=rsDonVi.getString("MADONVI")%>"
											selected="selected"><%=rsDonVi.getString("TENDONVI") %>
										</option>
										<%
											}else{
												 %>
										<option value="<%=rsDonVi.getString("MADONVI")%>"><%=rsDonVi.getString("TENDONVI") %>
										</option>
										<%
											}
										}
							...
							<TR>
								...
								<TD class="plainlabel">
									<% if(objnew.getTrangThai().equals("1")) {%> <input
									type="checkbox" name="trangThai" checked="checked" value="1">
									<%}else {%> <input type="checkbox" name="trangThai" value="1">
							...
							<TR>
								...
								<TD class="plainlabel"><input type="text" name="giaBan"
									value="<%=objnew.getGiaBan()%>"></TD>

							</TR>
							<TR>
								<TD class="plainlabel">Số lượng</TD>
								<TD class="plainlabel"><input type="text" name="soLuong"
									value="<%=objnew.getSoLuong()%>"></TD>
