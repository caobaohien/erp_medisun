...
<body>
	<form name="erpDmhForm" method="post" action="../../HoSoUpdateSvl">
		...
		<div align="left" id="header" style="width: 100%; float: none">
			<div style="width: 60%; padding: 5px; float: left"
				class="tbnavigation">Quản lý cung ứng</div>
			...
			<TABLE border="0" cellpadding="0" cellspacing="0">
				<TR class="tbdarkrow">
					...
					<TD width="30px" align="left"><span id="btnUndo"> <A
							href="../../HoSoListSvl?userId=<%=userId%>"> <IMG
		...
		<div class="plainlabel">
			<fieldset style="margin-top: 5px">
				<TABLE width="100%" cellpadding="6px" cellspacing="0px">
					<tr>
						<td class="plainlabel"><label>Ngày tạo hồ sơ:</label> <input
							class="days" type="text" maxlength="10" name="ngaytuvan"
							value="<%=obj.getNgaytaohoso()%>" /></td>
					</tr>
				</TABLE>
		</div>
		<div id="cotent" style="width: 100%; float: none">
			<div align="left"
				...
				<fieldset style="margin-top: 5px">
					...
					<legend>
						<span style="color: red" class="legendtitle">Thông tin học
							sinh</span>&nbsp;&nbsp;
					</legend>
					<TABLE width="100%" cellpadding="6px" cellspacing="0px"
						...
						<TR>
							...
							<TD class="plainlabel"><input type="text" name="hotenhs"
								value="<%=obj.getHoten() %>" /></TD>
							<TD class="plainlabel" width="15%">Ngày sinh</TD>
							<TD class="plainlabel"><input type="text" class="days"
								maxlength="10" name="ngaysinhhs" value="<%=obj.getNgaysinh() %>" />
							</TD>
						</TR>
						<TR>
						...
						<TR>
							...
							<TD class="plainlabel"><select class="select2"
								...
								multiple='multiple' onchange="submitform()">
									<option value=""></option>
									<%
						          ...
						          if (rsqg != null)
						          {
							           ...
							           {	
							        	   ...
							        	   {
							        		   if (obj.get_pk_seqquocgiahoc().get(i).equals("0")){
							        			   checkKhac = true;
									           }
									...
									<% if(checkKhac == true){ %>
									<option selected value="0">Khác</option>
									<% } else { %>
                    		...
                    		{%> <a href="" id="noidungGhiChu" rel="ndGhiChu">
									&nbsp; <img alt="Thêm Quốc Gia" src="../images/vitriluu.png">Thêm
									Quốc Gia
							</a>
								<DIV id="ndGhiChu"
									style="position: absolute; visibility: hidden; border: 9px solid #80CB9B; background-color: white; width: 300px; min-height: 150px; overflow: auto; padding: 2px;">
									<table width="80%" align="center" style="width: 250px">
										<tr>
											<th colspan="2" width="500px"
												style="font-size: 14px; font-weight: bold;">THÊM QUỐC
												GIA</th>

										</tr>

										<tr>
											<td width="40%">Mã quốc gia</td>
											<td width="60%"><input style="width: 100%"
												name="maquocgia" type="text" value="<%=obj.getMaquocgia()%>">
											</td>
										</tr>

										<tr>
											<td width="40">Tên quoc gia</td>
											<td width="60"><input style="width: 100%"
						...
						<TR>
                    		...
                    		{
                    	%> <input type="text" name="nguyenvongkhac"
								value="" maxlength="10" /> <%} %>
							</TD>
						...
						<TR>
							...
							<TD class="plainlabel"><input type="text" name="diachihs"
								maxlength="10" value="<%=obj.getDiachi() %>" /></TD>
							<TD class="plainlabel" width="15%">Điện thoại</TD>
							<TD class="plainlabel"><input type="text" maxlength="10"
								name="dienthoaihs" value="<%=obj.getDienthoai() %>" /></TD>
						</TR>

						<TR>
							<TD class="plainlabel" width="15%">Email</TD>
							<TD class="plainlabel"><input type="text" maxlength="10"
								name="emailhs" value="<%=obj.getEmail() %>" /></TD>
							<TD class="plainlabel" width="15%">FaceBook</TD>
							<TD class="plainlabel"><input type="text" maxlength="10"
								name="facebookhs" value="<%=obj.getfacebook()%>" /></TD>
						</TR>
			...
			<div align="left"
				...
				<fieldset style="margin-top: 5px">
					<legend>
						<span style="color: red" class="legendtitle">Thông tin phụ
							huynh</span>&nbsp;&nbsp;
					</legend>
					<TABLE width="100%" cellpadding="6px" cellspacing="0px"
						style="margin-top: 5px">
						...
						<TR>
							...
							<TD class="plainlabel"><input type="text" maxlength="10"
								name="hotencha" value="<%=obj.getHoten_cha()%>" /></TD>
							<TD class="plainlabel" width="15%">Họ Tên mẹ</TD>
							<TD class="plainlabel"><input type="text" maxlength="10"
								name="hotenme" value="<%=obj.getHoten_me() %>" /></TD>
						</TR>
						<TR>
							<TD class="plainlabel" width="15%">Sinh Ngày</TD>
							<TD class="plainlabel"><input type="text" class="days"
								maxlength="10" name="ngaysinhcha"
								value="<%=obj.getNgaysinh_cha() %>" /></TD>
							<TD class="plainlabel" width="15%">Sinh Ngày</TD>
							<TD class="plainlabel"><input type="text" class="days"
								maxlength="10" name="ngaysinhme"
								value="<%=obj.getNgaysinh_me() %>" /></TD>
						</TR>
						<TR>
							<TD class="plainlabel" width="15%">Địa chỉ (Nếu khác ở
								trên)</TD>
							<TD class="plainlabel"><input type="text" name="diachicha"
								maxlength="10" value="<%=obj.getDiachi_cha() %>" /></TD>
							<TD class="plainlabel" width="15%">Địa chỉ (Nếu khác ở
								trên)</TD>
							<TD class="plainlabel"><input type="text" name="diachime"
								maxlength="10" value="<%=obj.getDiachi_me() %>" /></TD>
						</TR>
						<TR>
							<TD class="plainlabel" width="15%">Số Điện thoại</TD>
							<TD class="plainlabel"><input type="text" maxlength="10"
								name="dienthoaicha" value="<%=obj.getDienthoai_cha()%>" /></TD>
							<TD class="plainlabel" width="15%">Số Điện thoại</TD>
							<TD class="plainlabel"><input type="text" maxlength="10"
								name="dienthoaime" value="<%=obj.getDienthoai_me()%>" /></TD>
						</TR>

						<TR>
							<TD class="plainlabel" width="15%">Nghề Nghiệp</TD>
							<TD class="plainlabel"><input type="text" maxlength="10"
								name="nghenghiepcha" value="<%=obj.getNghenghiep_cha() %>" /></TD>
							<TD class="plainlabel" width="15%">Nghề Nghiệp</TD>
							<TD class="plainlabel"><input type="text" maxlength="10"
								name="nghenghiepme" value="<%=obj.getNghenghiep_me()%>" /></TD>
						</TR>
			...
			<div align="left"
				...
				<fieldset style="margin-top: 5px">
					<legend>
						<span style="color: red" class="legendtitle">Thông tin
							khác</span>&nbsp;&nbsp;
					</legend>
					<TABLE width="100%" cellpadding="6px" cellspacing="0px"
						style="margin-top: 5px">
						...
						<TR>
							<TD class="plainlabel" width="25%">Thu nhập hàng tháng
								của gia đình</TD>
							<TD class="plainlabel"><input type="text" maxlength="10"
								name="thunhap" value="<%=obj.getThunhap_GD()%>" /></TD>
						</TR>
						<TR>
							<TD class="plainlabel" width="25%">Email (Nếu có)</TD>
							<TD class="plainlabel"><input type="text" maxlength="10"
								name="emailkhac" value="<%=obj.getEmail_khac() %>" /></TD>
						</TR>
						<TR>
							<TD class="plainlabel" width="25%">FaceBook (Nếu có)</TD>
							<TD class="plainlabel"><input type="text" maxlength="10"
								name="facebookkhac" value="<%=obj.getfacebook_khac() %>" /></TD>
						</TR>
