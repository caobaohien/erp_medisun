...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	...
	<form name="dmhForm" method="post" action="../../SanPhamNewSvl_Thu">

		<input type="hidden" name="userId" value='<%=userId%>'> <input
			type="hidden" name="action" value="1" /> <input type="hidden"
			name="maSanPham" value='<%=obj.getMaSanPham()%>'>
						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel"><input type="text" name="tenSanPham"
									value="<%=obj.getTenSanPham()%>" placeholder="EX: tên sản phẩm"></TD>
							</TR>
							...
							<TR>
								...
								<TD class="plainlabel"><input type="number" name="soLuong"
									value="<%=obj.getSoLương()%>"></TD>
							</TR>
							<!-- CHỌN GIÁ BÁN -->

							<TR>
								<TD class="plainlabel">Gía Bán:</TD>
