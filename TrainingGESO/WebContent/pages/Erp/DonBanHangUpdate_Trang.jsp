				...
				<fieldset>
						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							...
							<TR>
								...
								<TD class="plainlabel"><input type="text" name="tongTien"
									id="tongTien" value="<%= obj.getTongTien() %>"></TD>
							</TR>
						</TABLE>
						...
						%>
							<tr>
								<TD align="center" width="5%"><input type="text"
									...
									<input type="hidden" value="<%=sp.getSanPhamPK_SEQ() %>"
									name="idsp" style="width: 5%"></TD>
								...
								<TD align="center" width="10%"><input type="text"
									value="<%=sp.getSoLuongTon() %>" name="soluongton"
									style="width: 100%; text-align: right;"></TD>
								<TD align="center" width="10%"><input type="text"
					...
					while (soLuongSanPham < 20 + listsp.size()){%>
							<tr>
								...
								<TD align="center" width="10%"><input type="text" value=""
