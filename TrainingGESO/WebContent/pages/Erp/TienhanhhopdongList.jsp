...
<%@page
	import="geso.erp.beans.Tienhanhhopdongdaky_hieu.imp.TienhanhhopdongdakyList"%>
<%@page
	import="geso.erp.beans.Tienhanhhopdongdaky_hieu.ITienhanhhopdongdakyList"%>
<%@page
	import="geso.erp.beans.Tuvanthongtinhopdongdaky_hieu.imp.TuvanthongtinhopdongdakyList"%>
<%@page
	import="geso.erp.beans.Tuvanthongtinhopdongdaky_hieu.ITuvanthongtinhopdongdakyList"%>
<%@page
...
%>
<%
	ITienhanhhopdongdakyList obj = (TienhanhhopdongdakyList) session.getAttribute("obj");
%>
...
<body>
	<form name="erpDmhForm" method="post"
		action="../../TienhanhhopdongdakyListSvl_hieu">
					...
					<fieldset>
						...
						<TABLE width="100%" cellpadding="6" cellspacing="0">
							...
							<tr>
								...
								<td class="plainlabel">
									<%
										String mang4[] = new String[]{"1", "3"};
										String mangten4[] = new String[]{"Chưa chốt", "Đã chốt"};
						...
						<TABLE width="100%" border="1" cellspacing="1" cellpadding="4">
							...
							<TR class='tblightrow'>
								...
								<TD align="center"><A
									href="../../TienhanhhopdongdakyUpdateSvl_hieu?userId=<%=userId%>&display=<%=dataList.getString("ma")%>">
										<IMG src="../images/Display20.png" alt="Hiển thị"
										title="Hiển thị" border=0>
								</A>&nbsp; <%
 								if (tt.equals("1")) {
 									%> <A
									href="../../TienhanhhopdongdakyUpdateSvl_hieu?userId=<%=userId%>&update=<%=dataList.getString("ma")%>">
										<img src="../images/edit32.png" width="20" height="20"
										alt="Cap nhat" title="Cập nhật" border=0>
								</A>&nbsp; <A
									href="../../TienhanhhopdongdakyListSvl_hieu?userId=<%=userId%>&chot=<%=dataList.getString("ma")%>">
