...
<%
	IDonHang obj =(IDonHang)session.getAttribute("donhang");
...
function saveform(){
	document.forms["donhanglist"].action.value="luumoi";
	document.forms["donhanglist"].submit();
}
function savekhachhang()
{ 		
	document.forms["donhanglist"].action.value="savekhachhang";
    document.forms["donhanglist"].submit();
}
function goBack()
{
...
<input type="hidden"name="madonhang" value="<%=obj.getMadh() %>">
						...
						<tr height="22">
							<td align="left">
								...
								<table width="100%"cellspacing="0"cellpadding="0"border="0">
									...
									readonly="readonly" rows="2"><%=obj.getMsg() %></textarea>
									</fieldset>
									</td>
									</tr>
									</table>
								<table width="100%"cellspacing="0"cellpadding="0"border="0">
									...
									<table width="100%"cellspacing="0"cellpadding="3"border="0">
										...
										<td class="plainlabel">
										<input type="text"class="days"size="11"name="ngaydonhang"id="ngaydonhang"value="<%=obj.getNgaydh()%>"maxlength="10"readonly /></td>
									...
									<DIV id="ndGhiChu"
										...
										<table width="100%" align="center">
											...
											<tr>
												...
												<td width="80%"><input style="width: 100%" name="makh"
													type="text" value="<%=obj.getMakh() %>"></td>
											</tr>

											<tr>
												<td width="300px">Tên</td>
												<td width="300px"><input style="width: 100%"
													name="tenkh" type="text" value="<%=obj.getTenkh() %>">
												</td>
											</tr>
										...
										<td class="plainlabel"><select name="trangthai"
											onchange="submitform()" style="width: 200px">
												<option value="<%=obj.getTrangThai()%>">Toàn bộ</option>
												<%
										...
										<input type="text"name="smartId"id="smartId"style="width:200px"value="<%=obj.getMakh()%>"/>
										</td>
										<td class="plainlabel"width="190px">Tên khách hàng - Địa chỉ</td>
										<td class="plainlabel"colspan="5">
										<input type="text"name="khTen"id="khTen"style="width:100%"value="<%=obj.getTenkh()%>"readonly /></td>
										</tr>
										<tr class="tblightrow">
										<td class="plainlabel">VAT(%)</td>
										<td class="plainlabel">
										<input type="text"name="VAT"id="VAT"value="<%=obj.getVat()%>"onkeypress="return keypress(event);">%</td>
										<td class="plainlabel">Tổng số tiền</td>
										<td class="plainlabel"colspan="5">
										<input type="text"name="sotienchuaVAT"id="sotienchuaVAT"value="<%=obj.getTongtientruocVat()%>"readonly>VND</td>
										</tr>
										<tr class="tblightrow">
										<td class="plainlabel">Tổng số tiền(sau VAT)</td>
										<td class="plainlabel">
										<input type="text"name="sotiencoVAT"id="sotiencoVAT"value="<%=obj.getTongtiensauVat()%>"readonly>VND</td>
										<td class="plainlabel">Mã đơn hàng</TD>
								   		<td class="plainlabel"colspan="5"><input type="text"
										name="madonhang"value="<%=obj.getMadh()%>" placeholder="Ex: 100000">
										</td>
										</tr>
									</table>
									<hr>
									<table width="100%"cellpadding="5"border="0"style="font-size: 15px;">
										<tbody id="san_pham">
											...
											<th align="center"width="10%">Thành tiền</th>
													...
													<%
													int j=0;
													for(j=0;j<listSp.size();j++){
														
														%>
														<tr>
														<td align="center" width="2%"><input type="text"
                                                        value="<%=j+1%>" style="width:100%;text-align: center;"readonly="readonly">
														<input type="hidden"value="<%=listSp.get(j).getPK_SEQ() %>"name="spId"id="spId"
														style="width:100%"readonly="readonly"></td>
														
														<td align="left" width="8%">				
														<input type="text"name="masp"id="masp"value="<%=listSp.get(j).getMaSP() %>"onkeyup="ajax_showOptions(this,'donhang',event)"
														autocomplete="off"style="width:100%"></td>
														
														<td align="left"width="15%">
														<input type="text"name="tensp1"id="tensp1"value="<%=listSp.get(j).getTenSP() %>"
														readonly="readonly"style="width:100%"></td>
														
														<td align="center"width="6%">
														<input type="number"name="soluong"value="<%=listSp.get(j).getSoLuong() %>"
														style="width:100%;text-align:center;"></td>
														
														<td align="right"width="6%">
														<input type="text"name="donvitinh1"value="<%=listSp.get(j).getDVT() %>"
														style="width:100%;text-align:center;color:black;"></td>
														
														<td align="right"width="8%">
														<input type="text"name="dongia1"id="dongia1"value="<%=listSp.get(j).getDonGia() %>"
														style="width:100%;text-align:center;color:black;"readonly="readonly"></td>
														
														<td align="right" width="6%">
														<input type="text"name="chietkhau1"value="<%=listSp.get(j).getChietkhau() %>"
														style="width:100%;text-align:center;color:black;"></td>
										                
														<td align="right"width="10%">
														<input type="text"name="thanhtien1"value="<%=listSp.get(j).getThanhTien() %>"
														style="width:100%;text-align:center;color:black;"readonly="readonly"></td>
														</tr>
													...
													%>
											<%
													for(int i=listSp.size();i<listSp.size()+20;i++){
											%>
													<tr>
														<td align="center" width="2%"><input type="text"
														...
														<td align="left"width="8%">
														<input type="text"name="masp"id="masp"value=""onkeyup="ajax_showOptions(this,'donhang',event)"
														autocomplete="off"style="width:100%"></td>
