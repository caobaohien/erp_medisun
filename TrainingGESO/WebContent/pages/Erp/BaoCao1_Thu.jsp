<%@page import="geso.erp.beans.sanpham_thu.imp.*"%>
<%@page import="geso.erp.beans.sanpham_thu.*"%>
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<!-- chuyển tới trang svl new -->
	<form name="dmhForm" method="post" action="../../BaoCao1_ThuSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
				...
				<TABLE border="0" cellpadding="0" cellspacing="0">
					<TR class="tbdarkrow">
						...
						<TD width="30px" align="left"><span id="btnUndo"> <A
								href="../../SanPhamSvl_Thu?userId=<%=userId%>"> <IMG
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					<legend class="legendtitle"> Điều Kiện Lọc Báo Cáo </legend>
					<div style="float: none; width: 100%" align="left">

						<TABLE width="100%" cellpadding="4" cellspacing="0">

							<TR>
								<TD class="plainlabel">Bắt Đầu Từ Ngày:</TD>
								<TD class="plainlabel"><input type="text" name="ngayBatDau"
									class="days" value=""></TD>
							</TR>
							...
							<TR>
								...
								<TD class="plainlabel"><input type="text"
									name="ngayKetThuc" class="days" value=""></TD>
							</TR>

							<TR>
								<TD class="plainlabel">Theo Chi Nhánh/Hệ Thống:</TD>
								<TD class="plainlabel"><select type="text"
									name="tenChiNhanh" class="days" value="">
										<option value="Toàn Hệ Thống"></option></TD>
							</TR>
