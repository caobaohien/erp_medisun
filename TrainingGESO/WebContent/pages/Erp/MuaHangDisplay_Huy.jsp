...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post" action="../../MuaHangNewSvl">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					<legend class="legendtitle"> Thong tin don hang mua</legend>
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">

							<tr>
								<TD class="plainlabel">Tên NCC</TD>
								<td class="plainlabel"><select disabled name="tenncc"
									style="width: 200px">
							...
							<TR>
								<TD class="plainlabel">Ngay</TD>
								<TD class="plainlabel"><input type="text" name="ngay"
									value="<%=obj.getngay() %>" readonly></TD>

							</TR>


							<TR>
								<TD class="plainlabel">TOng tien</TD>
