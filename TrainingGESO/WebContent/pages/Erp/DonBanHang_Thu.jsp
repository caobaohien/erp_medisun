					...
					<fieldset>
								...
								<td class="plainlabel"><select name="khachHang"
									onchange="submitform()" style="width: 200px">
										...
										<option selected="selected"
											value="<%=rsKhachHang.getString("MA")%>">
                   	...
                   	%>
		                    ...
		                    %>
								...
								<TD align="center"><A
									href="../../DonBanHangNew_ThuSvl?userId=<%=userId%>&display=<%= dataList.getString("MADONHANG") %>">
										<IMG src="../images/Display20.png" alt="Hiển thị"
										title="Hiển thị" border=0>
								</A>&nbsp; <% 
				                    	if (!maTrangThai.equals("2")) {
				                    %> <A
									href="../../DonBanHangNew_ThuSvl?userId=<%=userId%>&update=<%= dataList.getString("MADONHANG") %>">
										<IMG src="../images/edit32.png" width="20" height="20"
										alt="Cap nhat" title="Cập nhật" border=0>
								</A>&nbsp; <% if (!maTrangThai.equals("1")) {%> <A
									href="../../DonBanHang_ThuSvl?userId=<%=userId%>&chot=<%= dataList.getString("MADONHANG")%>">
										<IMG src="../images/Chot.png" width="20" height="20"
										alt="Chot don hang" title="Chốt" border=0>
								</A>&nbsp; <% } %> <A
									href="../../DonBanHang_ThuSvl?userId=<%=userId%>&delete=<%= dataList.getString("MADONHANG")%>">
