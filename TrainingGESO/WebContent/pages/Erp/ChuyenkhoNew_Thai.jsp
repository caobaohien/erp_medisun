<%@page import="geso.erp.beans.chuyenkho_thai.IChuyenkho"%>
...
<script language="javascript" type="text/javascript">
	...
	function themmoi() {
		document.forms['chuyenkhonew'].action.value = 'taomoi';
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="chuyenkhonew" method="post" action="../../ChuyenkhoSvl">
					...
					<fieldset>
						...
						<TABLE width="100%" cellpadding="6" cellspacing="0">
							<tr>
								...
								<TD class="plainlabel"><input type="text" name="ngaychuyen"
									style="width: 200px" value="<%=obj.getNgaychuyen()%>"></TD>
							</tr>
							<tr>
								<TD class="plainlabel">Lý do chuyển</TD>
								<TD class="plainlabel"><input type="text" name="lydochuyen"
									style="width: 200px" value="<%=obj.getLydochuyen()%>"></TD>
							</tr>
							<tr>
							...
							<tr>
								...
								<TD class="plainlabel"><select name="trangthai"
									style="width: 200px">
										<option selected="selected">Chưa chốt</option>
								</select></TD>
							</tr>
