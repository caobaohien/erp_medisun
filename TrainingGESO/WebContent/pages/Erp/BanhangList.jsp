		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Bảng kê bán hàng</div>
					...
					<TABLE border="0" cellpadding="0" cellspacing="0">
						<TR class="tbdarkrow">
							...
							<TD width="40px" align="left"><span id="btnthem"> <A
									href="javascript:newform()"> <IMG src="../images/add32.png"
				...
				<div align="left"
					...
					<fieldset>
						...
						<TABLE width="100%" border="0" cellspacing="1" cellpadding="4">
							...
							<tr>
								<td align="center"><input value="<%=obj.getSochungtu()%>"
									name="sochungtu" type="text" style="width: 100px"
								...
								<td align="center"><input style="width: 100px" type="text"
									...
									onchange="submitform()" /> <input style="width: 100px"
									type="text" class="days" id="denngay" name="denngay"
									value="<%= obj.getDenngay() %>" maxlength="10"
									onchange="submitform()" /></td>
								<td align="center"><input type="text" name="khachangid"
									style="width: 200px" onchange="submitform()"></td>
								<td align="center">
									<%
					...
					int m = 0;
                   		...
                   		if(dmhList != null)
                   		{
							...
							<TR class='tblightrow'>
								...
								<TD align="center"><A
									href="../../BanhangUpdateSvl?userId=<%=userId%>&display=<%= dmhList.getString("sochungtu") %>"><IMG
										src="../images/Display20.png" alt="Hiển thị" title="Hiển thị"
										border=0></A>&nbsp; <% if(tt.equals("0")){ %> <A
									href="../../BanhangUpdateSvl?userId=<%=userId%>&update=<%= dmhList.getString("sochungtu")%>">
										<IMG src="../images/edit32.png" width="20" height="20"
										alt="Cap nhat" title="Cập nhật" border=0>
								</A>&nbsp; <A id='chotphieu<%=dmhList.getString("sochungtu")%>'
									href=""><img src="../images/Chot.png" alt="Chốt" width="20"
										height="20" title="Chốt" border="0"
										onclick="if(!confirm('Bạn có muốn chốt đơn hàng này?')) {return false ;}else{ processing('<%="chotphieu"+dmhList.getString("sochungtu")%>' , '../../BanhangSvl?userId=<%=userId%>&chot=<%= dmhList.getString("sochungtu")%>');}">
								</A> <A
									href="../../BanhangSvl?userId=<%=userId%>&delete=<%= dmhList.getString("sochungtu") %>"><img
										src="../images/DeleteRed_32.png" width="20" height="20"
										border=0 alt="Xóa Quản lý mua hàng"
										title="Xóa Quản lý mua hàng"
										onclick="if(!confirm('Bạn có muốn xóa đơn mua hàng này?')) return false;"></A>&nbsp;
									<%} %></TD>
							</TR>
							<% m++; } dmhList.close(); } %>
