		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Danh sách don mua hang</div>
								...
								<td class="plainlabel"><select name="tenncc"
									onchange="submitform()" style="width: 200px">
										...
										<option selected="selected"
											value="<%= dataListncc.getString("TEN") %>"><%= dataListncc.getString("TEN") %></option>
										<%} else%>
										<%{ %>
					...
					int m = 0;
                   		...
                   		if(dataList != null)
                   		{
							...
							<TR class='tblightrow'>
								...
								<TD align="center"><A
									href="../../MuaHangNewSvl?userId=<%=userId%>&display=<%= dataList.getString("MUAHANG_FK") %>"><IMG
										src="../images/Display20.png" alt="Hiển thị" title="Hiển thị"
										border=0></A>&nbsp; <% if(tt.equals("0")){ %> <A
									href="../../MuaHangNewSvl?userId=<%=userId%>&update=<%= dataList.getString("MUAHANG_FK")%>">
										<IMG src="../images/edit32.png" width="20" height="20"
										alt="Cap nhat" title="Cập nhật" border=0>
								</A>&nbsp; <A
									href="../../MuaHangSvl?userId=<%=userId%>&chot=<%= dataList.getString("MUAHANG_FK") %>"><img
										src="../images/Chot.png" width="20" height="20" border=0
										alt="chot Quản lý mua hàng" title="chot Quản lý mua hàng"
										onclick="if(!confirm('Bạn có muốn chot đơn mua hàng này?')) return false;"></A>&nbsp;
									<A
									href="../../MuaHangSvl?userId=<%=userId%>&delete=<%= dataList.getString("MUAHANG_FK") %>"><img
