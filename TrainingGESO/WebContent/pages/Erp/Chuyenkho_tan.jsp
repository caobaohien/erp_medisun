		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 70%; padding: 5px; float: left"
					class="tbnavigation">Dữ liệu nền>Cơ bản>Chuyển kho</div>
			...
			<div id="cotent" style="width: 100%; float: none; height: auto">
				...
				<div align="left"
					...
					<fieldset>
						<legend>
							<span class="legendtitle"> Chuyển kho&nbsp;&nbsp;&nbsp;</span> <a
								class="button" href="javascript:taomoi();"> <img
								style="top: -4px;" src="../images/New30.png" alt=""> <b>Tạo
									mới&nbsp; </b></a>
						</legend>
						<TABLE width="100%" border="1" cellspacing="1" cellpadding="4">
							<TR class="tbheader">
								<TH align="center" width="5%">Mã</TH>
								<TH align="center" width="10%">Lý do chuyển</TH>
		           ...
		           %>
		                    ...
		                    %> <%= Trangthai %>
								...
								<TD align="center"><A
									...
									href=""> <img src="../images/Chot.png" alt="Chốt"
										width="20" height="20" title="Chốt" border="0"
