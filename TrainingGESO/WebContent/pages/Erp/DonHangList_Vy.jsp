<%@page import="geso.erp.beans.donbanhang_vy.IDonHangList_Vy"%>
...
<%
	...
	IDonHangList_Vy obj = (IDonHangList_Vy) session.getAttribute("obj");
...
<body>
	<form name="erpDmhForm" method="post" action="../../DonHangListSvl_Vy">
					...
					<fieldset>
                   	...
                   	%>
		                    ...
		                    %>
								...
								<TD align="center"><A
									href="../../DonHangNewSvl_Vy?userId=<%=userId%>&display=<%= dataList.getString("MADONHANG") %>">
										<IMG src="../images/Display20.png" alt="Hiển thị"
										title="Hiển thị" border=0>
								</A>&nbsp; <% 
				                    	if (!maTrangThai.equals("2")) {
				                    %> <% if (!maTrangThai.equals("1")) {%> <A
									href="../../DonHangListSvl_Vy?userId=<%=userId%>&chot=<%= dataList.getString("MADONHANG")%>">
										<IMG src="../images/Chot.png" width="20" height="20"
										alt="Chot don hang" title="Chốt" border=0>
								</A>&nbsp; <A
									href="../../DonHangNewSvl_Vy?userId=<%=userId%>&update=<%= dataList.getString("MADONHANG") %>">
										<IMG src="../images/edit32.png" width="20" height="20"
										alt="Cap nhat" title="Cập nhật" border=0>
								</A>&nbsp; <% } %> <A
									href="../../DonHangListSvl_Vy?userId=<%=userId%>&delete=<%= dataList.getString("MADONHANG")%>">
