...
<SCRIPT language="javascript" type="text/javascript">
	 ...
	 {   
	    ...
	    document.forms["erpDmhForm"].ten.value = "";
	    document.forms["erpDmhForm"].submit();
	 } 
	 function thongbao()
	 {
...
<body>
	<form name="erpDmhForm" method="post" action="../../SanphamListSvl">
		<input type="hidden" name="userId" value="<%=userId %>"> <input
			type="hidden" name="action" value="muonlamgithidanhvaoday">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			...
			<div id="cotent" style="width: 100%; float: none">
				...
				<div align="left"
					...
					<fieldset>
						<legend>
							<span class="legendtitle"> san pham </span>&nbsp;&nbsp;
							...
							<tr>
								...
								<td class="plainlabel">
									<%
				                    		...
				                    		String mangten[] =new String[]{"Ngưng hoạt động","Hoạt động","test","test3"};
					...
					int m = 0;
                   		...
                   		if(dataList != null)
                   		{
							...
							<TR class='tblightrow'>
								...
								<TD align="center"><%=dataList.getString("DONVI")%></TD>
								...
								<TD align="center"><A
									href="../../SanphamNewSvl?userId=<%=userId%>&update=<%= dataList.getString("PK_SEQ")%>">
