...
<%@page import="geso.erp.beans.chuyenkho_hieu.IChuyenkhoList_hieu"%>
...
%>
<%
	IChuyenkhoList_hieu obj = (IChuyenkhoList_hieu) session.getAttribute("obj");
%>
					...
					<fieldset>
						...
						<TABLE width="100%" border="1" cellspacing="1" cellpadding="4">
							<TR class="tbheader">
								...
								<TH align="center" width="5%">Kho chuyển</TH>
								<TH align="center" width="5%">Kho nhận</TH>
								<TH align="center" width="27%">Lý do chuyển</TH>
								<TH align="center" width="10">Người tạo</TH>
								<TH align="center" width="10%">Ngày tạo</TH>
								<TH align="center" width="10%">Người sữa</TH>
								<TH align="center" width="10%">Ngày sữa</TH>
							...
							<TR class='tblightrow'>
								...
								<TD align="center"><A
									href="../../ChuyenkhoUpdateSvl_hieu?userId=<%=userId%>&display=<%=dataList.getString("ma")%>">
										<IMG src="../images/Display20.png" alt="Hiển thị"
										title="Hiển thị" border=0>
								</A>&nbsp; <%
 								if (tt.equals("0")) {
 									%> <A
									href="../../ChuyenkhoListSvl_hieu?userId=<%=userId%>&delete=<%=dataList.getString("ma")%>">
										<img src="../images/DeleteRed_32.png" width="20" height="20"
										border=0 name=delete alt="Xóa" title="Xóa">
								</A>&nbsp; <A
									href="../../ChuyenkhoUpdateSvl_hieu?userId=<%=userId%>&update=<%=dataList.getString("ma")%>">
										<img src="../images/edit32.png" width="20" height="20"
										alt="Cap nhat" title="Cập nhật" border=0>
								</A>&nbsp; <A
									href="../../ChuyenkhoListSvl_hieu?userId=<%=userId%>&chot=<%=dataList.getString("ma")%>">
