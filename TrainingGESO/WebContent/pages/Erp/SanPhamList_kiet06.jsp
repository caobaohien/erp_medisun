...
<body>
	<form name="sanphamlist" method="post"
		action="../../SanPhamListSvl_kiet06">
		<input type="hidden" name="userId" value="<%=userId%>"> <input
			type="hidden" name="action" value=""> <input type="hidden"
			name="crrApprSplitting" value="<%=spList.getCrrApprSplitting()%>">
		<input type="hidden" name="nxtApprSplitting"
			value="<%=spList.getNxtApprSplitting()%>">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
				...
				<TABLE border="0" cellpadding="0" cellspacing="0">
					<TR class="tbdarkrow">
						...
						<td width="30px" align="left"><A
							href="../../PDF_SanPhamSvl_kiet?userId=<%=userId%>"> <IMG
						...
						<TD width="30px" align="left"><A
							href="../../Excel_SanPhamSvl_kiet?userId=<%=userId%>"> <IMG
								src="../images/Excel2013.png" alt="Xuất file Excel"
								title="Excel" border=0>
						</A></TD>
					</TR>
				</TABLE>
			...
			<div id="cotent" style="width: 100%; float: none">
				...
				<div align="left"
					...
					<fieldset>
						<legend>
							<span class="legendtitle"> Sản phẩm Kiệt 06 </span>&nbsp;&nbsp;
						...
						<TABLE width="100%" border="1" cellspacing="1" cellpadding="4">
							...
							: "Ngưng Hoạt Động")%></th>
							 ...
							 %>
								...
								<TD align="center">
									<% if(tt.equals("1")){%> <A
									href="../../SanPhamNewSvl_kiet06?userId=<%=userId%>&update=<%= rsDataList.getString("PK_SEQ") %>">
										<IMG src="../images/edit32.png" width="20" height="20"
										alt="Cập nhật" title="Cập nhật" border=0>
								</A>&nbsp; <A
									href="../../SanPhamListSvl_kiet06?userId=<%=userId%>&delete=<%= rsDataList.getString("PK_SEQ")%>">
										<IMG src="../images/DeleteRed_32.png" width="20" height="20"
										alt="Xóa sản phẩm" title="Xóa" border=0>
								</A>&nbsp; <% } %> <A
									href="../../SanPhamNewSvl_kiet06?userId=<%=userId%>&display=<%= rsDataList.getString("PK_SEQ") %>">
