...
<%@page import="geso.erp.beans.donbanhang_vy.imp.DonHang_Vy"%>
<%@page import="geso.erp.beans.donbanhang_vy.IDonHang_Vy"%>
...
<% 
	IDonHang_Vy iDonHang_Vy = (IDonHang_Vy) session.getAttribute("donHangMoi");
	String userId = (String) session.getAttribute("userId");
	String userTen = (String) session.getAttribute("userTen");
  	ResultSet resultSetKH = iDonHang_Vy.getResultSetKH();
  	
  	//Lay thuoc tinh danh sach san pham tu don hang
  	List<ISanPham_Vy> danhSachSanPham = iDonHang_Vy.getDanhSachSanPham();
...
<script type="text/javascript" src="../scripts/erp-SanPhamList.js"></script>
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post" action="../../DonHangNewSvl_Vy">
		<input type="hidden" name="userId" value='<%= userId %>'> <input
			type="hidden" name="action" value="1" /> <input type="hidden"
			name="maDonHang" value='<%= iDonHang_Vy.getMaDonHang() %>'>
				...
				<TABLE border="0" cellpadding="0" cellspacing="0">
					<TR class="tbdarkrow">
						...
						<TD width="30px" align="left"><span id="btnUndo"> <A
								href="../../DonHangListSvl_Vy?userId=<%=userId%>"> <IMG
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					...
					<textarea name="dataerror" id="Msg" rows="1" readonly="readonly"
						style="height: 50px; width: 100%"><%= iDonHang_Vy.getMsg() %></textarea>
				</fieldset>
			</div>
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
						...
						<TABLE width="100%" cellpadding="4" cellspacing="0">
									...
									style="width: 200px">
										...
										if (resultSetKH != null) {
											while (resultSetKH.next()) {
												if ( resultSetKH.getString("MAKHACHHANG").equals(iDonHang_Vy.getMaKhachHang()) ) {
									%>
							...
							<TR>
								...
								<TD class="plainlabel"><input type="text"
									...
									value="<%= iDonHang_Vy.getNgayChungTu() %>"></TD>
							</TR>
							...
							<TR>
								...
								<TD class="plainlabel"><input type="text" name="tongTien"
									...
									style="text-align: right; font-size: 14px; font-weight: bold value="<%= iDonHang_Vy.getTongTien() %>"></TD>
								<% System.out.println(iDonHang_Vy.getTongTien()); %>
							</TR>
					...
					<div align="left" style="width: 100%; float: none; clear: none;">
						...
						if(spList.size() > 0) { */
							...
							if (danhSachSanPham.size() > 0) {
								Iterator<ISanPham_Vy> iteratorSanPham = danhSachSanPham.iterator();
						...
						%>
							<TR>
								<TD align="center" width="2%"><input type="text"
									...
									value="<%= elementSanPham.getPk_seq() %>" name="PK_SEQ"
									style="width: 100%" readonly="readonly"></TD>

								<TD align="left" width="8%"><input type="text"
									name="maSanPham" value="<%= elementSanPham.getMaSanPham() %>"
								...
								<TD align="right" width="3%"><input type="number"
									name="soLuong" value="<%= elementSanPham.getSoLuong() %>"
									style="text-align: center;"></TD>
