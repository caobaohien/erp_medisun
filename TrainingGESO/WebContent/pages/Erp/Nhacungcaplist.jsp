...
<body>
	<form name="erpDmhForm" method="post" action="../../NhacungcapSvl">
					...
					int m = 0;
                   		...
                   		if(dataList != null)
                   		{
							...
							<TR class='tblightrow'>
								...
								<TD align="center"><A
									href="../../NhacungcapNewSvl?userId=<%=userId%>&update=<%= dataList.getString("sochungtu")%>">
