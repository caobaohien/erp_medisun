...
<%@page
	import="geso.erp.beans.Tienhanhhopdongdaky_hieu.imp.TienhanhhopdongdakyUpdate"%>
<%@page
	import="geso.erp.beans.Tienhanhhopdongdaky_hieu.ITienhanhhopdongdakyUpdate"%>
<%@page
	import="geso.erp.beans.Tuvanthongtinhopdongdaky_hieu.imp.TuvanthongtinhopdongdakyUpdate"%>
<%@page
	import="geso.erp.beans.Tuvanthongtinhopdongdaky_hieu.ITuvanthongtinhopdongdakyUpdate"%>
...
<%
	ITienhanhhopdongdakyUpdate obj = (TienhanhhopdongdakyUpdate) session.getAttribute("obj");
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post"
		action="../../TienhanhhopdongdakyUpdateSvl_hieu">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation">Thông tin các kế hoạch định hướng thị
					trường</div>
				...
				<TABLE border="0" cellpadding="0" cellspacing="0">
					<TR class="tbdarkrow">
						...
						<TD width="30px" align="left"><span id="btnUndo"> <A
								href="../../TienhanhhopdongdakyListSvl_hieu?userId=<%=userId%>">
			...
			<div align="left" style="width: 100%; float: none; clear: left">
				<fieldset>
					...
					<div style="float: none; width: 100%" align="left">
						<TABLE width="100%" cellpadding="4" cellspacing="0">
							<tr>
								...
								<TD class="plainlabel"><select readonly="readonly"
									name="mahopdong" onchange="loadthongtin()" style="width: 200px">
										<option></option>
										<%
											if (dataListck != null) {
												while (dataListck.next()) {
													if (dataListck.getString("pk_seq").equals(obj.getMahopdong())) {
										%>
					...
					<fieldset>
						<legend class="legendtitle"> Thông tin cá nhân khách hàng
						</legend>
						<div style="float: none; width: 100%" align="left">
							<TABLE width="100%" cellpadding="4" cellspacing="0">
								<TR>
								...
								<TR>
									<TD class="plainlabel" width="15%">Trình độ học vấn</TD>
									<TD class="plainlabel"><input type="text" readonly
										name="hocvan" value="<%=obj.getTrinhdohocvan() %>" /></TD>
									<TD class="plainlabel" width="15%">Khả năng tiếng anh</TD>
									<TD class="plainlabel"><input type="text" maxlength="10"
										readonly name="tienganh"
										value="<%=obj.getkhanangtienganh() %>" /></TD>
								</TR>

								<TR>
									<TD class="plainlabel" width="15%">Nguyện vọng đi học</TD>
									<TD class="plainlabel"><input type="text" readonly
										name="nguyenvongdihoc" value="<%=obj.getNguyenvong() %>" /></TD>
									<TD class="plainlabel" width="15%">Khả năng học vấn</TD>
									<TD class="plainlabel"><input type="text" maxlength="10"
										readonly name="khananghocvan"
										value="<%=obj.getKhananghocvan() %>" /></TD>
								</TR>
					...
					<fieldset>
						...
						<div style="float: none; width: 100%" align="left">
							<TABLE width="100%" cellpadding="4" cellspacing="0">
								<TR>
									<TD class="plainlabel" width="15%" align="left">Chuẩn bị</TD>
									<TD class="plainlabel" align="left">
										<div style="width: 800px">

											<div style="padding-right: 6px;">
												<textarea readonly="readonly" rows="5" name="chuanbi"
                             ...
                             <%=obj.getChuanbi()%>
								...
								<TR>
									...
									<TD class="plainlabel"><input readonly="readonly"
										class="days" type="text" name="ngayphongvan"
										value="<%=obj.getNgayphongvan() %>" /></TD>
								</TR>
								<TR>
									<TD class="plainlabel" width="15%">Giờ phỏng vấn</TD>
									<TD class="plainlabel"><input readonly="readonly"
										type="text" name="giophongvan"
										value="<%=obj.getGiophongvan() %>" /></TD>
								</TR>
								<TR>
									<TD class="plainlabel" width="15%">Ngày nhập học dự kiến
									</TD>
									<TD class="plainlabel"><input readonly="readonly"
										class="days" type="text" name="ngaynhaphocdukien"
