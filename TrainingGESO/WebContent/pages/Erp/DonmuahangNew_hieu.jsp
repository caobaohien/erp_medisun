										...
										<table width="100%" align="center">
											<tr>
												<th colspan="2" width="500px"
													style="font-size: 14px; font-weight: bold;">THÊM NHÀ
													CUNG CẤP</th>
											...
											<tr>
												...
												<td width="300px"><input style="width: 100%"
													...
													value="<%=obj.getTennhacungcap() %>"></td>
											</tr>

											<tr>
												<td width="300px">Điện thoại ncc</td>
												<td width="300px"><input style="width: 100%"
													type="text" name="dienthoaincc"
													value="<%=obj.getDienthoainhacungcap()%>"></td>
											</tr>

											<tr>
												<td width="300px">Địa chỉ ncc</td>
												<td width="300px"><input style="width: 100%"
													type="text" name="diachincc"
													value="<%=obj.getDiachinhacungcap()%>"></td>
											</tr>

											<tr>
												<td></td>
												<td width="300px"><A href="javascript:savenhacungcap()">
