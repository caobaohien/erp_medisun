...
<%
	IThongtinsanpham nccBean = (IThongtinsanpham) session.getAttribute("obj");
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post" action="../../SanphamNewSvl">
								...
								<TD class="plainlabel"><select name="donvi"
									style="width: 500px">
										...
										<option value="<%=rsdvt.getString("pk_seq")%>"
											selected="selected"><%=rsdvt.getString("ten") %>
										</option>
										<%
											}else{
												 %>
										<option value="<%=rsdvt.getString("pk_seq")%>"><%=rsdvt.getString("ten") %>
										</option>
										<%
											}
										}
