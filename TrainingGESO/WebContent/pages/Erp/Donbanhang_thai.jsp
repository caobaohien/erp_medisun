<%@page import="geso.erp.beans.donbanhang_thai.IDonbanhang"%>
...
<%	
	IDonbanhang obj = (IDonbanhang) session.getAttribute("dhnew");
...
<script type="text/javascript" src="../scripts/ErpListSpNhom2.js"></script>
...
<BODY leftmargin="0" bottommargin="0" topmargin="0" rightmargin="0">
	<form name="dmhForm" method="post" action="../../DonhangNewSvl_thai">
		...
		<div id="main" style="width: 100%; padding-left: 2px">
			<div align="left" id="header" style="width: 100%; float: none">
				<div style="width: 60%; padding: 5px; float: left"
					class="tbnavigation">Đơn bán hàng</div>
				...
				<TABLE border="0" cellpadding="0" cellspacing="0">
					<TR class="tbdarkrow">
						...
						<TD width="30px" align="left"><span id="btnUndo"> <A
								href="../../DonbanhangListSvl_thai?userId=<%=userId%>"> <IMG
						...
						<table class="tabledetail" width="100%" border="0" cellpadding="2"
							...
							<tr>
								...
								<TD align="center" width="8%"><input type="text"
									name="masp" style="width: 100%" value="<%=sp.getMasanpham() %>"
