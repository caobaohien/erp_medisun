...
<body OnLoad="document.passForm.oldpass.focus();">
	<form name="passForm" method="post" action="/TrainingGESO/LoginSvl">
		<input type="hidden" name="login" value="2"></input>
		<table width="100%" height="35%" border="0" cellpadding="0"
			cellspacing="0">
			<tr bgcolor="#FFFFFF">
				<td width="14%" height="80" align="right" valign="middle" colspan=2><img
					src="pages/images/logoCanfoco.jpg" width="80" height="80"
					align="right" /></td>
				<td width="32%" align="left" valign="middle" class="title">&nbsp;</td>
				<td width="52%" align="right" class="footer"
					style="padding-right: 15">&nbsp;</td>
			</tr>
			<tr class="tblightrow" height="3">
				<td colspan="3" align="center" class="plainlabel">Vì lý do an
					ninh, vui lòng thay đổi mật
					mã&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			...
			<tr class="tblightrow" height="1">
				...
				<td class="blanc" align="left"><input type="password"
					name="oldpass" value="" size="20"></td>
			</tr>

			<tr class="tblightrow" height="1">
				<td colspan="2" align="right" class="blanc">Mật mã mới&nbsp;</td>
				<td class="blanc" align="left"><input type="password"
					name="newpass1" value="" size="20"></td>
			</tr>

			<tr class="tblightrow" height="1">
				<td colspan="2" align="right" class="blanc">Nhập lại mật mã
					mới&nbsp;</td>
				<td class="blanc" align="left"><input type="password"
					name="newpass2" value="" size="20"></td>
			</tr>

			<tr height="1">
				<td height="5" class="blanc" colspan="2" align="right">&nbsp;</td>
				<td class="blanc" align="left"><input type="button"
					value="Luu lai" onClick="check();"></td>
			</tr>
